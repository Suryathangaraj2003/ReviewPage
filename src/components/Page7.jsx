        ...
        <div className=''>
            ...
            <div className='flex flex-row my-8 text-left  '>
                ...
                <div className='flex flex-row'>
                    <p className='  mt-8 sm:w-full sm:flex '>Foundation Math Build your foundation skills in algebra,geometry,and probability
                    <img src={page7_img} alt="" srcset="" className='h-20 w-20  sm:mb-4'/>
                    </p>
                    </div>
                
                </div>
                <div className='border-2 ml-2 mr-2 sm:flex flex-row roundedhover:shadow-md hover:border-yellow-500 w-6/12 sm:mr-16 xl:mr-20 2xl:mr-32  rounded p-2 '>
                    <p className='pt-10'><b>Mathematical THinking</b> build your foundational skills in algebra,geometry and probability
                    </p>
                    <img src={page7_img} alt="" srcset="" className='h-20 w-20 '/>
